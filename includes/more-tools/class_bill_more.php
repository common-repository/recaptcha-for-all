<?php // namespace recaptcha_for_all_BillMore {
if (!defined("ABSPATH")) {
    exit();
...
add_action("init", "recaptcha_for_all_bill_more");
// >>>>>>>>>>>>>>>>>>>>>>>
*/
class recaptcha_for_all_Bill_Minozzi_Add_Ajax_Url
{
...
$recaptcha_for_all_bill_minozzi_add_ajax_url = new recaptcha_for_all_Bill_Minozzi_Add_Ajax_Url();
class recaptcha_for_all_Bill_show_more_plugins
{
    //
    public function __construct()
    {
        ...
        // add_action('wp_ajax_bill_install_plugin2', array('\recaptcha_for_all_BillMore\Bill_show_more_plugins', 'bill_install_plugin2'));
        ...
        // work add_action('wp_ajax_bill_install_plugin2', '\recaptcha_for_all_BillMore\bill_install_plugin2');
    }
...
$show_more_plugins = new recaptcha_for_all_Bill_show_more_plugins();
// } // end namespace
class recaptcha_for_all_PluginInstaller
{
    public function __construct()
    {
    ...
    public function bill_install_plugin2()
    {
        ...
        $plugin = $slug;
        $skin = new \recaptcha_for_all_bill_install_QuietSkin(["api" => $api]);
...
$plugin_installer = new recaptcha_for_all_PluginInstaller();
//$plugin_installer->install_plugin();
require_once ABSPATH . "wp-admin/includes/plugin-install.php";
require_once ABSPATH . "wp-admin/includes/class-wp-upgrader.php";
class recaptcha_for_all_bill_install_QuietSkin extends \WP_Upgrader_Skin
{
    public function __construct()
    {
        parent::__construct();
...
$quiet_skin = new recaptcha_for_all_bill_install_QuietSkin();
