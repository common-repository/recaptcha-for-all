<?php namespace recaptcha_for_all_BillInstall;
//
/**
 * @ Author: Bill Minozzi
...
use recaptcha_for_all_BillDiagnose\MemoryChecker;
use recaptcha_for_all_BillDiagnose\ErrorChecker;
// ------------------------- Ago 24 -------------------- 

  if (!class_exists('recaptcha_for_all_BillDiagnose\MemoryChecker')) {
      return;
  }
...
/////////////// Class Begin //////////////////
class recaptcha_for_all_Bill_Class_Plugins_Install
{
    ...
    public function pre_checkup_page_content()
    {
        ...
        switch ($step) { case 1: ?> 
                <div class="bill_install_wrap">
                    ...
                    $diagnose_instance = new recaptcha_for_all_Bill_Class_Plugins_Install(
...
$plugin_install = new recaptcha_for_all_Bill_Class_Plugins_Install(
    $plugin_slug,
    $notification_url,
    $notification_url2,
    $plugin_text_domain,
