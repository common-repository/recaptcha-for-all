  ...
  <style>
    html { 
      ...
      .recaptcha_for_all_box {
        position: fixed;
        width: <?php echo esc_attr($recaptcha_for_all_box_width);?>;
        max-width:100%;
        padding: 10px;
        border: 1px solid gray;
        margin: 0px auto;
        text-align: center;
        background-color: <?php echo esc_attr($recaptcha_for_all_background_color);?>;
        color: <?php echo esc_attr($recaptcha_for_all_foreground_color);?>;
        font-size: 16px;
        z-index: 9999999;
        <?php
      ...
      #recaptcha_for_all_button{
        background-color: <?php echo esc_attr($recaptcha_for_all_btn_background_color);?>;
        color: <?php echo esc_attr($recaptcha_for_all_btn_foreground_color);?>;
...
<?php
$recaptcha_for_all_allowed_atts = array(
  'align'      => array(),
  'class'      => array(),
  'type'       => array(),
  'id'         => array(),
...
$recaptcha_for_all_my_allowed['strong']   = $recaptcha_for_all_allowed_atts;
$recaptcha_for_all_my_allowed['small']    = $recaptcha_for_all_allowed_atts;
$recaptcha_for_all_my_allowed['h1']       = $recaptcha_for_all_allowed_atts;
$recaptcha_for_all_my_allowed['h2']       = $recaptcha_for_all_allowed_atts;
$recaptcha_for_all_my_allowed['h3']       = $recaptcha_for_all_allowed_atts;
$recaptcha_for_all_my_allowed['h4']       = $recaptcha_for_all_allowed_atts;
$recaptcha_for_all_my_allowed['h5']       = $recaptcha_for_all_allowed_atts;
$recaptcha_for_all_my_allowed['h6']       = $recaptcha_for_all_allowed_atts;
$recaptcha_for_all_my_allowed['hr']       = $recaptcha_for_all_allowed_atts;
$recaptcha_for_all_my_allowed['i']        = $recaptcha_for_all_allowed_atts;
$recaptcha_for_all_message = trim(wp_kses(get_option('recaptcha_for_all_message', ''), $recaptcha_for_all_my_allowed));
...
<body>
  <div class="recaptcha_for_all_box">
    <?php echo (wp_kses($recaptcha_for_all_message, $recaptcha_for_all_my_allowed)); ?>
      <?php
      if( $recaptcha_for_all_settings_provider == 'turnstile'){
            echo '<form id="recaptcha_for_all999" action="'.esc_url(sanitize_text_field($_SERVER['REQUEST_URI'])).'" method="POST">';
            $theme = 'dark'; 
            $language = 'auto'; 
            $unique_id = mt_rand(); 
            ...
            ?>
            <form id="recaptcha_for_all" action="<?php echo esc_url(sanitize_text_field($_SERVER['REQUEST_URI'])); ?>" method="POST">
            <br>
            <?php
          }
      ?>
